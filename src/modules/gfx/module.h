...
namespace graphics {
    ...
    typedef sMesh (*CreateMesh)(sVertex* vertices, size_t vertexSize, sIndex* indices, size_t indexSize);
...
struct GraphicsModule : Module {
    ...
    sMesh createMesh(sVertex* vertices, size_t vertexCount, sIndex* indices, size_t indexCount) {
        sMesh mesh = internal_createMesh(vertices, vertexCount, indices, indexCount);
        mesh.creator = this;
        return mesh;
    }
