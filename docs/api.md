...
# struct `sInternalFont::CharacterDef` 
...
#### `public double `[`dt`](#structs_window_1a7f9230324980123678753482ec6535b6) 

Delta time since the last frame.

This is the time in seconds since the last frame was rendered.

#### `public int `[`width`](#structs_window_1adc0627042bc57195d20a7252b32025d6) 

The width of the window.

This is the width of the window in pixels.

#### `public int `[`height`](#structs_window_1a453cdecf356a4c1d7ef3eaa56e2ce875) 
...
#### `public bool `[`vsync`](#structs_window_flags_1ae2b9e4039cfa0be4f2c85c4eb58214c3) 
...
#### `public bool `[`resizable`](#structs_window_flags_1a729ab07e65c58ac8233996eaba286391) 
...
## Summary
 ...
 Members                        | Descriptions                                
--------------------------------|---------------------------------------------
`public window::WindowLoader `[`internal_loadWindow`](#struct_window_module_1a399b2a327965a6fc0c9b81e5fd861b1a) | 
`public window::WindowUpdate `[`internal_updateWindow`](#struct_window_module_1adacdcd6f0911e4f9a438eca0d0192961) | 
`public window::WindowDestructor `[`destroyWindow`](#struct_window_module_1ad00018c7fea20adaa84fb25b4e2f81d2) | Destructor function pointer for the window module.
`public window::WindowSwapBuffers `[`swapBuffers`](#struct_window_module_1a830e7730d7aa0475d2960eaa9ed93a88) | 
`public window::WindowShouldClose `[`shouldClose`](#struct_window_module_1a761b27f730dbb756202cc021684517b8) | 
`public window::WindowSetShouldClose `[`setShouldClose`](#struct_window_module_1a35e85beef243f215098b7d4b0985364d) | 
`public window::WindowGetHandle `[`getHandle`](#struct_window_module_1a1886bf8b942e4c197439c1a2b984cd0a) | 
`public window::WindowIsKeyPressed `[`isKeyPressed`](#struct_window_module_1ae2d4a41fd40706989d5e18974075fd7a) | 
`public window::WindowIsMouseButtonPressed `[`isMouseButtonPressed`](#struct_window_module_1a5572df3a45e8a0dc08a2318b9f115389) | 
`public window::WindowGetMousePosition `[`getMousePosition`](#struct_window_module_1a30bb291cc83f8f4870ef38dea8655eb0) | 
...
`public inline  explicit `[`WindowModule`](#struct_window_module_1a2427e19698191d79b01bde5e380533ff)`(const char * dynlib)` | 
...
#### `public window::WindowDestructor `[`destroyWindow`](#struct_window_module_1ad00018c7fea20adaa84fb25b4e2f81d2) 

Destructor function pointer for the window module.

This function is used to destroy a window created by the window module. This function will be loaded from the module file (a dynamic library), and the implementation may vary.
